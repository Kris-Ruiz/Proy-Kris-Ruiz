<x-layouts.app :title="__('Nuevo Taller')">
    <div class="p-6">
        <div class="max-w-2xl mx-auto">
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white mb-6">Nuevo Taller</h1>
            
            <form action="{{ route('talleres.store') }}" method="POST" class="space-y-6">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <input type="number" name="cupo" id="cupo" required value="{{ old('cupo') }}" min="1"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-white focus:border-indigo-500 focus:ring-indigo-500">
                </div>
