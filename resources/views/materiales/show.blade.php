<x-layouts.app :title="__('Detalle Material')">
    <div class="p-6">
        <div class="max-w-2xl mx-auto">
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white mb-6">Detalle del Material</h1>
            
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
                <div class="p-6 space-y-4">
                    <div class="border-b dark:border-gray-700 pb-4">
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Nombre</h3>
                        <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $materiale->nombre }}</p>
                    </div>
                    
                    <div class="border-b dark:border-gray-700 pb-4">
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Descripción</h3>
                        <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $materiale->descripcion }}</p>
                    </div>
                    
                    <div class="border-b dark:border-gray-700 pb-4">
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Cantidad</h3>
                        <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $materiale->cantidad }}</p>
                    </div>

                    <div class="pb-4">
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Taller</h3>
                        <p class="mt-1 text-sm text-gray-900 dark:text-white">
                            {{ $materiale->taller ? $materiale->taller->nombre : 'No asignado' }}
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-700/50 px-6 py-4">
                    <div class="flex justify-end space-x-3">
                        ...
                        <a href="{{ route('materiales.edit', $materiale) }}" 
